...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    {
        private readonly UserManager<AsterCellUser> _userManager;
        ...
        public ExternalController(
            UserManager<AsterCellUser> userManager,
        ...
        private async Task<(AsterCellUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<AsterCellUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
